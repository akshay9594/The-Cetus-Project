...
public class RangeExpression extends Expression {
    ...
    */
    public RangeExpression(Expression lb, Expression ub) {
      ...
      addChild(lb);
      addChild(ub);
      addChild(new IntegerLiteral(1));
    }

    /**
     * Constructs a range expression with the given lower, upper bounds, and stride.
     *
     * @param lb the lower bound expression.
     * @param ub the upper bound expression.
     * @param stride the stride expression
     * @throws IllegalArgumentException if <b>lb</b> or <b>ub</b> is invalid.
     * @throws NotAnOrphanException if <b>lb</b> or <b>ub</b> has a parent.
     */
    public RangeExpression(Expression lb, Expression ub, Expression stride) {
        super(3);
        object_print_method = class_print_method;
        addChild(lb);
        addChild(ub);
    ...
    */
    ...
    /**
     * Sets the stride with the specified expression.
     * @param stride the new upper bound
     * @throws NotAnOrphanException if <b>ub</b> has a parent.
     */
    ...
    */
    ...
    /**
     * Returns the stride of this range expression.
     */
