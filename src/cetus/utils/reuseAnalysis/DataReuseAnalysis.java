...
public final class DataReuseAnalysis {
    ...
    public DataReuseAnalysis(Loop loopNest) {
        ...
        this.loopNestMemoryOrder = runReuseAnalysis();
    }
    ...
    public List<Expression> runReuseAnalysis() {
        return runReuseAnalysis(64);
    }

    /**
     * To see full documentation see: {@link DataReuseAnalysis#runReuseAnalysis()}
     * 
    ...
    public List<Expression> runReuseAnalysis(int cacheSize) {
